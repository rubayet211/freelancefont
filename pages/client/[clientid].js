          ...
          <>
            ...
            <div className="flex items-center space-x-5 text-xs">
              <div className="space-x-5">
                <Button
                  text="Settings"
                  design="border-black border-2 text-black px-5 py-2 rounded font-bold"
                />
                <Button
                  text="Log Out"
                  design="bg-white text-black border px-5 py-2 rounded font-bold"
                />
              </div>
            </div>
          </>
        ...
        <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0">
          <div className="flex flex-col justify-center gap-4">
            <h1 className="md:leading-[72px] py-2 md:text-6xl text-5xl font-semibold">
              {" "}
              Welcome <span className="text-[#20B486]">{}</span>
            </h1>
          </div>
