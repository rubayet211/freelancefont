      ...
      <main>
        ...
        <div className="flex flex-col items-center justify-center mt-[30rem] mb-[30rem] ml-10 w-[60rem] h-[70rem] px-28 pt-20 bg-emerald-50 dark:bg-gradient-to-r from-slate-900 via-emerald-900 to-sky-900">
          ...
          <p className="text-center text-gray-700 dark:text-gray-200">
            Your role is pivotal in crafting our freelance haven. Create, edit,
            and delete reports and announcements seamlessly. Navigate with
            precision using powerful search tools. As the guardian of accuracy,
            edit freelancer and client profiles with finesse. Enjoy Link unique
            admin view, contributing to our community's success. Your warm
            welcome sets the tone for Link collaborative and thriving freelance
            environment. Thrilled to have you on board! 🚀
          </p>
        </div>
