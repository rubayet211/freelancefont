...
import ValidationFreelancer from "../ValidationFreelancer";
...
const Signup = () => {
    ...
    function handleInput(event) {
      ...
      function handleValidation(event) {
        ...
        // console.log(errors);
        setErrors(ValidationFreelancer(values));
            ...
            <div className="mt-2 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white py-8 px-4 shadow-2xl sm:rounded-lg sm:px-10">
                    <form method="post" enctype="multipart/form-data" onSubmit={handleValidation}>
                        ...
                        <div>
                            <label for="email" className="block text-sm font-medium leading-5  text-gray-700">Hourly Rate</label>
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input id="hr" name="hr" onChange={handleInput} type="text" className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                            {errors.name && <p className="text-sm text-red-700 font-bold">{errors.name}</p>}
                        </div>
                        ...
                        <div className="mt-3">
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input id="email" name="email" onChange={handleInput} type="email" className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5
                "/>
                        ...
                        <div className="mt-3">
                            ...
                            <div className="mt-1 rounded-md shadow-sm">
                                <input id="password_confirmation" name="confirmpassword" onChange={handleInput} type="text" className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
